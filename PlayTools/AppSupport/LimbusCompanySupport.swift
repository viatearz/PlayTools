//
//  LimbusCompanySupport.swift
//  PlayTools
//

class LimbusCompanySupport: AppSupport {
    override func applyHooks() {
        DispatchQueue.main.asyncAfter(deadline: .now() + .milliseconds(1)) {
            ...
            self.swizzleInstanceMethod(
                ...
                newSelector: #selector(NSObject.hook_LimbusCompany_createRootViewController)
            )
        }
    }
}
...
extension NSObject {
    @objc func hook_LimbusCompany_createRootViewController() -> UIViewController {
        ...
        return self.hook_LimbusCompany_createRootViewController()
    }
}
